...
export const SKILLS = {
  ...
  LEARNING: {
    ...
    SKILL: [
      ...
      { NAME: 'Programmation Orienté Objet', SVG: null },
...
export const PROJECTS = {
  ...
  PROJECTS_TO_DISPLAY: ['BAY', 'AERONOTES', 'POKEDEX', 'BOOKI', 'OHMYFOOD', 'KANAP', 'PIIQUANTE', 'GROUPOMANIA'],
  ...
  PIIQUANTE:{
    ...
    DOC_URL: 'https://app.swaggerhub.com/apis-docs/ClementBellier/OC_Piiquante/1.0.0',
    IMAGE_URL: '/assets/piiquante.png',
    SUBTITLE: "Construisez une API sécurisée pour une application d'avis gastronomiques",
    DESCRIPTION:
  ...
  GROUPOMANIA:{
    ...
    DOC_URL: 'https://app.swaggerhub.com/apis-docs/ClementBellier/OC_Groupomania/1.0.0',
